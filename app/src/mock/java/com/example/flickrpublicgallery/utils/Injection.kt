...
import com.example.flickrpublicgallery.model.source.MockFlickrGalleryDataSource
...
object Injection : Injector {
    ...
    override fun provideFlickrGalleryRepository(): FlickrGalleryRepository {
        return FlickrGalleryRepository(MockFlickrGalleryDataSource(provideFlickrAPI().getFlickrGalleryService()))
    }
